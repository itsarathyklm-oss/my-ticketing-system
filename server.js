...
app.post('/tickets', upload.single('screenshot'), async (req, res) => {
    try {
        ...
        const newTicket = new Ticket({
            ...
            assignedTo: assignedStaff.name // Save the actual NAME string directly (e.g., 'SADIQ')
        });
